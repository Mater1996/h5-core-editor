(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['lbp-notice-bar'] = {}));
	...
	*/
	...
	// Utils
	// Components
	var _createNamespace = (0, utils.createNamespace)('nav-bar'),
	    createComponent = _createNamespace[0],
	    bem = _createNamespace[1];
	  ...
	  methods: {
	    ...
	    genNavBar: function genNavBar() {
	      ...
	      return h("div", {
	        ...
	        }), (_ref = {}, _ref[constant.BORDER_BOTTOM] = this.border, _ref)]
	      }, [h("div", {
	        "class": bem('content')
	      }, [this.hasLeft() && h("div", {
	        "class": bem('left'),
	...
	var NoticeBar = /*@__PURE__*/getDefaultExportFromCjs(navBar);
