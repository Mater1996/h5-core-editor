(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['lbp-table'] = {}));
	...
	*/
	...
	// `Array.prototype.reduce` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.reduce
	_export({ target: 'Array', proto: true, forced: !STRICT_METHOD || !USES_TO_LENGTH$1 || CHROME_BUG }, {
	...
	*/
	...
	var index$2 = {
	  ...
	  props: {
	    ...
	    theme: index$1.string({
	      label: '主题'
	    }),
	    columnWidth: index$1.number({
	      label: '每列宽度(px)'
	    }),
	    freezeCount: index$1.number({
	      label: '冻结列数(px)'
	    })
	  },
	  watch: {
	  ...
	  mounted: function mounted() {
	    ...
	    this.setTableWidth();
	    this.setFixedTableStyle();
	    addListener(this.$refs.lbpTable, this.__resizeHandler);
	  },
