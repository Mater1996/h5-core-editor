(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['lbp-slide'] = {}));
	...
	*/
	...
	function enter (vnode, toggleDisplay) {
	  ...
	  var explicitEnterDuration = toNumber$2(
	    isObject$2(duration)
	      ? duration.enter
	      : duration
	  );
	...
	function leave (vnode, rm) {
	  ...
	  var explicitLeaveDuration = toNumber$2(
	    isObject$2(duration)
	      ? duration.leave
	      : duration
	  );
	...
	var bem = /*#__PURE__*/Object.defineProperty({
		createBEM: createBEM_1
	}, '__esModule', {value: true});

	var deepAssign_2 = deepAssign;
	...
	function assignKey(to, from, key) {
	  ...
	  if (!(0, utils.isDef)(val)) {
	    return;
	  }

	  if (!hasOwnProperty$3.call(to, key) || !(0, utils.isObject)(val)) {
	    to[key] = val;
	  } else {
	...
	var deepAssign_1 = /*#__PURE__*/Object.defineProperty({
		deepAssign: deepAssign_2
	}, '__esModule', {value: true});
	...
	var require$$0 = /*@__PURE__*/getAugmentedNamespace(vue_runtime_esm);
	...
	var _vue = interopRequireDefault(require$$0);



	var _zhCN = interopRequireDefault(zhCN);
	...
	var _default = {
	  ...
	  add: function add(messages) {
	    ...
	    (0, deepAssign_1.deepAssign)(proto.$vantMessages, messages);
	  }
	};
	exports.default = _default;
	});
	...
	var unifySlots_1 = unifySlots;
	var createComponent_1 = createComponent$1;
	...
	function install(Vue) {
	  ...
	  Vue.component((0, string$1.camelize)("-" + name), this);
	...
	function createComponent$1(name) {
	  return function (sfc) {
	    if ((0, utils.isFunction)(sfc)) {
	      sfc = transformFunctionComponent(sfc);
	    }

	    if (!sfc.functional) {
	      sfc.mixins = sfc.mixins || [];
	      sfc.mixins.push(slots.SlotsMixin);
	    }
	...
	var component = /*#__PURE__*/Object.defineProperty({
		unifySlots: unifySlots_1,
		createComponent: createComponent_1
	}, '__esModule', {value: true});

	var createI18N_1 = createI18N;
	...
	function createI18N(name) {
	  var prefix = (0, string$1.camelize)(name) + '.';
	  return function (path) {
	    var messages = _locale.default.messages();

	    var message = (0, utils.get)(messages, prefix + path) || (0, utils.get)(messages, path);

	    for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
	      args[_key - 1] = arguments[_key];
	    }

	    return (0, utils.isFunction)(message) ? message.apply(void 0, args) : message;
	  };
	}

	var i18n = /*#__PURE__*/Object.defineProperty({
		createI18N: createI18N_1
	}, '__esModule', {value: true});

	var createNamespace_1 = createNamespace;
	...
	function createNamespace(name) {
	  name = 'van-' + name;
	  return [(0, component.createComponent)(name), (0, bem.createBEM)(name), (0, i18n.createI18N)(name)];
	}

	var create = /*#__PURE__*/Object.defineProperty({
		createNamespace: createNamespace_1
	}, '__esModule', {value: true});
	...
	var addUnit_1 = addUnit;
	var unitToPx_1 = unitToPx;
	...
	function addUnit(value) {
	  if (!(0, utils.isDef)(value)) {
	    return undefined;
	  }

	  value = String(value);
	  return (0, number$1.isNumeric)(value) ? value + "px" : value;
	} // cache
	...
	var unit = /*#__PURE__*/Object.defineProperty({
		addUnit: addUnit_1,
		unitToPx: unitToPx_1
	}, '__esModule', {value: true});
	...
	exports.createNamespace = create.createNamespace;



	exports.addUnit = unit.addUnit;
	var inBrowser = typeof window !== 'undefined';
	...
	var style$1 = /*#__PURE__*/Object.defineProperty({
		isHidden: isHidden_1
	}, '__esModule', {value: true});
	...
	var raf_2 = raf$1;
	var doubleRaf_1 = doubleRaf;
	var cancelRaf_1 = cancelRaf;
	...
	var root = utils.isServer ? commonjsGlobal : window;
	/* istanbul ignore next */
	...
	var raf_1 = /*#__PURE__*/Object.defineProperty({
		raf: raf_2,
		doubleRaf: doubleRaf_1,
		cancelRaf: cancelRaf_1
	}, '__esModule', {value: true});

	var range_1 = range;
	var formatNumber_1 = formatNumber;
	...
	var number$2 = /*#__PURE__*/Object.defineProperty({
		range: range_1,
		formatNumber: formatNumber_1
	}, '__esModule', {value: true});
	...
	var TouchMixin = {
	  ...
	  methods: {
	    ...
	    bindTouchEvent: function bindTouchEvent(el) {
	      ...
	      (0, event.on)(el, 'touchstart', onTouchStart);
	      (0, event.on)(el, 'touchmove', onTouchMove);

	      if (onTouchEnd) {
	        (0, event.on)(el, 'touchend', onTouchEnd);
	        (0, event.on)(el, 'touchcancel', onTouchEnd);
	      }
	    }
	  }
	};
	...
	var sortChildren_1 = sortChildren;
	...
	var vnodes = /*#__PURE__*/Object.defineProperty({
		sortChildren: sortChildren_1
	}, '__esModule', {value: true});

	var ChildrenMixin_1 = ChildrenMixin;
	var ParentMixin_1 = ParentMixin;
	  ...
	  return {
	    ...
	    methods: {
	      bindRelation: function bindRelation() {
	        ...
	        (0, vnodes.sortChildren)(children, this.parent);
	...
	var relation = /*#__PURE__*/Object.defineProperty({
		ChildrenMixin: ChildrenMixin_1,
		ParentMixin: ParentMixin_1
	}, '__esModule', {value: true});

	var BindEventMixin_1 = BindEventMixin;
	...
	function BindEventMixin(handler) {
	  var key = "binded_" + uid$4++;

	  function bind() {
	    if (!this[key]) {
	      handler.call(this, event.on, true);
	      this[key] = true;
	    }
	  }
	  ...
	  function unbind() {
	    if (this[key]) {
	      handler.call(this, event.off, false);
	      this[key] = false;
	    }
	  }
	...
	var bindEvent = /*#__PURE__*/Object.defineProperty({
		BindEventMixin: BindEventMixin_1
	}, '__esModule', {value: true});
	...
	// Utils
	// Mixins
	var _createNamespace = (0, utils.createNamespace)('swipe'),
	    createComponent = _createNamespace[0],
	    bem = _createNamespace[1];

	var _default = createComponent({
	  mixins: [touch.TouchMixin, (0, relation.ParentMixin)('vanSwipe'), (0, bindEvent.BindEventMixin)(function (bind, isBind) {
	  ...
	  methods: {
	    ...
	    initialize: function initialize(active) {
	      ...
	      if (!this.$el || (0, style$1.isHidden)(this.$el)) {
	        return;
	      }
	    ...
	    onTouchMove: function onTouchMove(event$1) {
	      if (!this.touchable || !this.swiping) return;
	      this.touchMove(event$1);

	      if (this.isCorrectDirection) {
	        (0, event.preventDefault)(event$1, this.stopPropagation);
	        this.move({
	          offset: this.delta
	        });
	      }
	    ...
	    getTargetActive: function getTargetActive(pace) {
	      ...
	      if (pace) {
	        if (this.loop) {
	          return (0, number$2.range)(active + pace, -1, count);
	        }

	        return (0, number$2.range)(active + pace, 0, maxCount);
	      }
	    ...
	    getTargetOffset: function getTargetOffset(targetActive, offset) {
	      ...
	      if (!this.loop) {
	        targetOffset = (0, number$2.range)(targetOffset, this.minOffset, 0);
	      }
	...
	var Swipe = /*@__PURE__*/getDefaultExportFromCjs(swipe);
	...
	var swipeItem = createCommonjsModule(function (module, exports) {
	...
	var _createNamespace = (0, utils.createNamespace)('swipe-item'),
	    createComponent = _createNamespace[0],
	    bem = _createNamespace[1];

	var _default = createComponent({
	  mixins: [(0, relation.ChildrenMixin)('vanSwipe')],
	  data: function data() {
	    return {
	      offset: 0,
	      inited: false,
	...
	var SwipeItem = /*@__PURE__*/getDefaultExportFromCjs(swipeItem);
	...
	var index$3 = {
	  name: 'lbp-slide',
	  props: {
	    interval: index$1.number({
	      label: '间隔时间'
	    }),
	    editorMode: index$1.string({
	      label: '模式'
	    }),
	    activeIndex: {
	      type: Number,
